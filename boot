 ...
 * grub-pc [amd64 i386]
 * ${Kernel-Stem}-generic-lts-xenial [i386]          # our chosen default install kernel

== powerpc ==

 * yaboot [powerpc]
 * ${Kernel-Stem}-powerpc-smp-lts-xenial [powerpc]   # powerpc kernel, 32-bit machines
 * ${Kernel-Stem}-powerpc64-smp-lts-xenial [powerpc] # powerpc kernel, 64-bit machines

== ppc64el ==

 * grub-ieee1275 [ppc64el]
 * ${Kernel-Stem}-generic-lts-xenial [ppc64el]       # default install kernel for ppc64el

== amd64 ==

 * ${Kernel-Stem}-generic-lts-xenial [amd64]         # amd64 kernel, works on all machines though not optimised

== armel / armhf ==

 * ${Kernel-Stem}-generic-lts-xenial [armhf]         # multiplatform kernel, will eventually replace others
 ...
 * ${Kernel-Stem}-generic-lts-xenial [arm64]
