 ...
 * grub-pc [amd64 i386]
 * ${Kernel-Stem}-generic-lts-wily [i386]          # our chosen default install kernel

== powerpc ==

 * yaboot [powerpc]
 * ${Kernel-Stem}-powerpc-smp-lts-wily [powerpc]   # powerpc kernel, 32-bit machines
 * ${Kernel-Stem}-powerpc64-smp-lts-wily [powerpc] # powerpc kernel, 64-bit machines

== ppc64el ==

 * grub-ieee1275 [ppc64el]
 * ${Kernel-Stem}-generic-lts-wily [ppc64el]       # default install kernel for ppc64el

== amd64 ==

 * ${Kernel-Stem}-generic-lts-wily [amd64]         # amd64 kernel, works on all machines though not optimised

== armel / armhf ==

 * ${Kernel-Stem}-generic-lts-wily [armhf]         # multiplatform kernel, will eventually replace others
 ...
 * ${Kernel-Stem}-generic-lts-wily [arm64]
